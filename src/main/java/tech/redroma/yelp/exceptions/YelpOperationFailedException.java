...
public class YelpOperationFailedException extends YelpExcetion
{
    ...
    public YelpOperationFailedException(String message)
    {
        super(message);
    }

    public YelpOperationFailedException(String message, Throwable cause)
    {
        super(message, cause);
    }

    public YelpOperationFailedException(Throwable cause)
    {
        super(cause);
    }
